...
const blockedBattleSchema = new mongoose.Schema({
    category_id: {
        type: String,
        required: true
    },
...
const blockedBattleModel = mongoose.model('blocked_user_battles', blockedBattleSchema);

module.exports = blockedBattleModel;
